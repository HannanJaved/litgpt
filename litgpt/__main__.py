...
from litgpt.finetune.finetune_backward import setup as finetune_backward_fn
...
from litgpt.generate.sequentially_backward import main as generate_sequentially_backward_fn
...
def main() -> None:
    parser_data = {
        ...
        "finetune_backward": finetune_backward_fn,
        ...
        "generate_sequentially_backward": generate_sequentially_backward_fn,
